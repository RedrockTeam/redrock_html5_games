...
//            }
          ...
          switch($game)
          {
              ...
              case 'takephotos':
                  Redirect::to("https://open.weixin.qq.com/connect/oauth2/authorize?appid=$this->appid&redirect_uri=http%3a%2f%2fhongyan.cqupt.edu.cn%2fgame%2fpublic%2frealtakephotos&response_type=code&scope=snsapi_base&state=123#wechat_redirect");
              case 'realtakephotos':
                  return $CODE;
