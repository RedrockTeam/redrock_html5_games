...
//                if($save['openid'] != '')
        ...
        public function getPartyQuestion(){
            ...
            switch($level) {
                ...
                case 2:
                    $question = [
                        '1.认真学习马克思列宁主义、毛泽东思想、邓小平理论、“三个代表”重要思想和科学发展观，学习党的路线、方针、#，学习党的基本知识，学习科学、文化、法律和业务知识，努力提高&的本领。',
                        '2.贯彻执行党的#和各项方针、政策，带头参加改革开放和社会主义现代化建设，带动群众为经济发展和社会进步艰苦奋斗，在生产、工作、学习和社会生活中起&作用。',
                        '3.坚持的利益高于一切，个人利益服从#的利益，&，享受在后，克己奉公，多做贡献。',
                        '4.自觉遵守#，模范遵守国家的法律法规，严格保守党和国家的秘密，执行党的决定，&，积极完成党的任务。',
                        '5.维护党的#，对党忠诚老实，&，坚决反对一切派别组织和小集团活动，反对阳奉阴违的两面派行为和一切阴谋诡计。',
                        '6.切实开展#，勇于揭露和纠正工作中的缺点、错误，坚决同&作斗争。',
                        '7.#，向群众宣传党的主张，遇事同群众商量，及时向党反映群众的&，维护群众的正当利益。',
                        '8.发扬社会主义新风尚，带头实践社会主义荣辱观，提倡#，为了保护国家和人民的利益，在一切困难和危险的时刻&，英勇斗争，不怕牺牲。',
                    ];
                    $answer = [
                        ['政策和决议', '为人民服务'],
                        ['基本路线', '先锋模范'],
                ...
                case 3:
                    $question = [
                        '1.参加党的#，阅读党的有关文件，接受党的&。',
                        '2.在党的会议上和#上，参加关于党的&的讨论。',
                        '3.对#提出&。',
                        '4.在党的会议上#批评党的任何组织和任何党员，向党&党的任何组织和任何党员违法乱纪的事实，要求处分违法乱纪的党员，要求罢免或撤换不称职的干部。',
                        '5.行使#、选举权，有&。',
                        '6.在党组织讨论决定对党员的党纪处分或作出鉴定时，#和进行申辩，其他党员可以为他&。',
                        '7.对党的决议和政策如有不同意见，在#的前提下，可以声明保留，并且可以把自己的意见向&直至中央提出。',
                        '8.向党的上级组织直至中央提出#，并要求有关组织给以&。',
                    ];
                    $answer = [
                        ['有关会议','教育和培训'],
                        ['党报党刊','政策问题'],
                ...
                case 4:
                    $question = [
                        '1、在新的历史条件下，我们党面临着执政、改革开放、<span class="answer"> </span>、外部环境“四大考验”。',
                        '2、在新的历史条件下，我们党面临着精神懈怠、能力不足、<span class="answer"> </span>、消极腐败“四大危险”。',
                        '3、全面提高党的建设科学化水平，全党要增强紧迫感和责任感，牢牢把握的主线是<span class="answer"> </span>。',
                        '4、不断提高党的领导水平和执政水平、提高<span class="answer"> </span>能力，是党巩固执政地位、实现执政使命必须解决好的重大课题。',
                        '5、对马克思主义的信仰，对社会主义和共产主义的信念，是共产党人的<span class="answer"> </span>。',
                        '6、为人民服务是党的根本宗旨，以人为本、<span class="answer"> </span>是检验党一切执政活动的最高标准。',
                        '7、党内<span class="answer"> </span>是党的生命。',
                        '8、要严格党内<span class="answer"> </span>，健全党员党性定期分析、民主评议等制度。',
                        '9、党章规定的各项纪律都必须严格遵守和执行，而最首要、最核心的就是要严格遵守和执行党的<span class="answer"> </span>。',
                        '10、<span class="answer"> </span>是党的根本组织原则。',
                        '11、新时期党的干部工作的重要指导方针是<span class="answer"> </span>。',
                        '12、中国共产党是中国工人阶级的先锋队，同时是<span class="answer"> </span>。',
                        '13、党的最高理想和最终目标是<span class="answer"> </span>。',
                        '14、中国共产党以马克思列宁主义、毛泽东思想、邓小平理论和<span class="answer"> </span>作为自己的行动指南。',
                        '15、党的根本宗旨是<span class="answer"> </span>。',
                        '16、党的领导主要是<span class="answer"> </span>的领导。',
                        '17、党的思想路线是一切从实际出发，理论联系实际，<span class="answer"> </span>，在实践中检验真理和发展真理。',
                        '18、党员如果没有正当理由，连续<span class="answer"> </span>不参加党的组织生活，或不交纳党费，或不做党所分配的工作，就被认为是自行脱党。',
                        '19、企业、农村、机关、学校、科研院所、街道社区、社会团体、社会中介组织、人民解放军连队和其他基层单位，凡是有正式党员<span class="answer"> </span>，都应当成立党的基层组织。',
                        '20、党的纪律是党的各级组织和全体党员必须遵守的<span class="answer"> </span>，是维护党的团结统一、完成党的任务的保证。'
                    ];
                    $select = [
                        ['商品经济','市场经济'],
                        ['贪污腐败','脱离群众'],
