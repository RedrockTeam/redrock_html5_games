...
<head lang="zh-hans">
    <meta charset="UTF-8">
    {{HTML::script("resource/run/js/jquery-2.1.1.min.js")}}
...
<!--            <img src="images/loading.jpg">-->
        ...
        <div id="begin_web">
            {{HTML::image("resource/run/images/begin_bg.jpg")}}
<!--            <img src="images/begin_bg.jpg" id="begin_bg">-->
        ...
        <div id="tips_web">
            {{HTML::image("resource/run/images/tips.jpg")}}
<!--            <img src="images/tips.jpg" id="tips_img">-->
        ...
        <div id="share">
            {{HTML::image("resource/run/images/share.jpg")}}
