...
<head lang="zh-hans">
    ...
    {{HTML::style("game/resource/run/css/style.css")}}
<!--    <link rel="stylesheet" type="text/css" href="style.css">-->
    <title>奔跑吧兄弟</title>
    {{HTML::script("game/resource/run/js/API.js")}}
<!--    <script src="js/API.js"></script>-->
<!--    <script src="js/normal.js"></script>-->
    {{HTML::script("game/resource/run/js/normal.js")}}
</head>
<body>
...
<div id="container">
    ...
    <div id="loading">
        {{HTML::image("game/resource/run/images/loading.jpg")}}
<!--        <img src="images/loading.jpg">-->
    </div>
    <div id="begin_web">
        {{HTML::image("game/resource/run/images/begin_bg.jpg","tu",array('id'=>'begin_bg'))}}
<!--        <img src="images/begin_bg.jpg" id="begin_bg">-->
    ...
    <div id="tips_web">
        {{HTML::image("game/resource/run/images/tips.jpg","tu",array('id'=>'tips_img'))}}
<!--        <img src="images/tips.jpg" id="tips_img">-->
    ...
    <div id="share">
        {{HTML::image("game/resource/run/images/share.jpg","tu",array('id'=>'share_img'))}}
