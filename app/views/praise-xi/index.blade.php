<html>
	<head>
		...
		<script src="{{URL::asset('game/js/praise-xi/ajax.js?d=vdds')}}"></script>
		<script src="{{URL::asset('game/js/praise-xi/main.js?d=vdds')}}"></script>
		<script src="{{URL::asset('game/js/praise-xi/API.js?d=vdsf')}}"></script>
	...
	<body>
		...
		<div class="game-back">
			<div class="beginPage">
				<img src="{{URL::asset('game/images/Xi-logo.png')}}" class="logo">
				<div class="slogan">
